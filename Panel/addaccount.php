                  ...
                  <div class="row">
                      <div class="col-md-12">
                          ...
                          <div class="form-group">
                              ...
                              <input name="kad" type="text" id="helperText" class="form-control" placeholder="Kullanıcı Adı Girin">

                              </p>
                          </div>
                          <div class="form-group">
                              <label for="helperText">Şifre</label>
                              <input name="sifre" type="text" id="helperText" class="form-control" placeholder="Şifre Girin">
              ...
              <div class="form-group">
                ...
                <select class="form-select" name="yetki">
                  ...
                  <option value="0"> İhtiyac Sahibi </option>
                      ...
                      <div class="buttons">
 <button name="kullanicikaydet" type="submit" class="btn btn-outline-primary">Ekle</button>
</div>
                      </div>
                  </div>
              </div>
