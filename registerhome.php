	...
	<div class="limiter">
		<div class="container-login100" style="background: #F2F7FF;">
			<div class="wrap-login100 p-l-110 p-r-110 p-t-62 p-b-33">
				<center><h3>AYİTO Web Sistemi Kayıt Anasayfası</h3></center>
				<?php 
      ...
      <?php } ?>
				<div class="container-login100-form-btn m-t-17">
					...
					<a style="
						...
						font-size: 16px;
						color: #fff;
						line-height: 1.2; " href="register" class="login100-form-btn">
						Öğrenci Kayıt Ol</a>
				</div>
				<div class="container-login100-form-btn m-t-17">
					<a style="
						...
						font-size: 16px;
						color: #fff;
						line-height: 1.2;" href="register0" class="login100-form-btn">
						İhtiyaç Sahibi Kayıt Ol</a>
				</div>
